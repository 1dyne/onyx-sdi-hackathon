...
3. Record the task and conditions: indoor/outdoor, footwear, socks, orthosis, chair, hand support, therapist assistance, opposite-foot contact, mounting and goal/notes. Center default is indoor without shoes. Each completed baseline gets a condition ID; captures retain a snapshot rather than a mutable global profile.
...
- Baseline engineering checks: at least 10 received packets, at least 2 seconds of coverage in the 3-second window, no gap over 600 ms including window ends, channel P90–P10 spread at most 35 ADC counts, median below 1000. These are initial data-quality thresholds, not clinically validated accuracy limits. Baseline samples, check limits and headroom are retained.
